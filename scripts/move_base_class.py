...
if __name__ == "__main__":
    ...
    send_coordinates_object = SendCoordinates("home_env1")
    send_coordinates_object = SendCoordinates("pick_env1")
    send_coordinates_object = SendCoordinates("place_a_env1")
