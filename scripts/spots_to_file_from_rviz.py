...
from geometry_msgs.msg import PoseWithCovarianceStamped, PointStamped, Quaternion
import rospkg
...
class RBKairosPoseRetriever(object):
    ...
    def pose_service_callback(self, request):
        ...
        with open(self.spot_file_path, "a") as myfile:
            spot_position = self.point_now.point
            spot_orientation = Quaternion(w=1.0)
